...
export const metadata: Metadata = {
  title: "Optick — Vedi cosa succede prima di premere invio",
      ...
      <body className="font-sans">
        <header className="border-b border-abtg-border bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
            <a href="/" className="flex items-center gap-3 min-w-0">
              <Image src="/logo-abtg.svg" alt="Optick" width={40} height={40} className="h-10 w-10 rounded-md shrink-0" priority />
              <div className="min-w-0">
                <div className="text-abtg-navy font-black tracking-tight text-xl leading-none">Optick</div>
        ...
        <footer className="border-t border-abtg-border mt-12 bg-white">
          <div className="max-w-7xl mx-auto px-6 py-5 text-xs text-abtg-muted">
            ...
            © Optick — strumento didattico di Alfio Bardolla Training Group.
          </div>
        </footer>
      </body>
    </html>
